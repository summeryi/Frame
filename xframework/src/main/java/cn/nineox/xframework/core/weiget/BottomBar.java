    ...
    public BottomBar addItem(final BottomBarTab tab) {
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tab instanceof RoundBottomBarTab) {
                    mListener.onRoundTabSelected();
                } else {
        ...
        if (tab instanceof RoundBottomBarTab == false) {
            tab.setTabPosition(count);
            count++;
            mTabs.add(tab);
        }
