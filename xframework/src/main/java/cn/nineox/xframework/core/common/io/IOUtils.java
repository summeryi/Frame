...
import cn.nineox.xframework.core.common.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return cn.nineox.xframework.core.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        cn.nineox.xframework.core.common.io.stream.ByteArrayOutputStream output = new cn.nineox.xframework.core.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
