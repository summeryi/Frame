...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        setLeftTextColor(mDefaultTextColor);
        ...
        setTitleColor(mDefaultTextColor);
        setSubTitleColor(mDefaultTextColor);
        ...
        mCenterText.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
